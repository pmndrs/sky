 ...
 */
export const presets: Record<string, AtmosphereParams> = {
  earth: EARTH,

  mars: mergeAtmosphereParams(EARTH, {
    bottomRadius: 3389.5,
    topRadius: 3449.5, // ~60 km shell
    rayleighScattering: new Vector3(0.003, 0.0024, 0.0014), // CO2-thin, slightly red-biased
    rayleighDensityExpScale: -1.0 / 11.0, // Mars scale height ~11.1 km
    mieScattering: new Vector3(0.018, 0.012, 0.006), // dust
    mieExtinction: new Vector3(0.02, 0.013, 0.007),
    ...
    groundAlbedo: new Vector3(0.45, 0.3, 0.18), // regolith
  }),

  titan: mergeAtmosphereParams(EARTH, {
    bottomRadius: 2575.0,
    topRadius: 2775.0, // 200 km renderer shell
    rayleighScattering: new Vector3(0.0008, 0.001, 0.0014), // negligible at visible
    rayleighDensityExpScale: -1.0 / 25.0, // tall atmosphere
    mieScattering: new Vector3(0.02, 0.011, 0.004), // tholin orange
...
export function resolvePreset(nameOrObject: string | AtmosphereParams): AtmosphereParams {
