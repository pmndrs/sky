 ...
 */
export function createAtmosphereUniforms(params: AtmosphereParams) {
  return {
    // Geometry
...
/** The uniform bundle returned by {@link createAtmosphereUniforms}. */
 ...
 */
export function updateAtmosphereUniforms(uniforms: AtmosphereUniforms, params: AtmosphereParams): void {
