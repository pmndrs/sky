import { BackSide, Camera, Mesh, NodeMaterial, SphereGeometry, Vector3 } from 'three/webgpu'
...
export class GroundedSkybox extends Mesh {
  ...
  constructor(
    cube: any,
    { height = 4, radius = 200, resolution = 128, reflective = false }: GroundedSkyboxOptions = {},
  ) {
