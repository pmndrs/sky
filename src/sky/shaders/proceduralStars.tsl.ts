import { Fn, float, vec2, vec3, dot, floor, fract, length, mix, pow, sin, smoothstep, step } from 'three/tsl'
 ...
 */
export const proceduralStars = /*@__PURE__*/ Fn(([uvNode, densityNode, brightnessScaleNode]: any) => {
...
function _hash21(p: any, seed: any) {
  const k = dot(p, seed)
